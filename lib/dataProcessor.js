...
class DataProcessor {
    ...
    static getPatientsTumorInfo(neo4jRawArr) {
        let self = this;
        ...
        for (let i = 0; i < neo4jRawArr.length; i++) {
            if (uniquePatientsArr.indexOf(neo4jRawArr[i].patientId) === -1) {
                uniquePatientsArr.push(neo4jRawArr[i].patientId);
            } 
        }
        ...
        uniquePatientsArr.forEach(function(patientId) {
            ...
            let patientTumorInfoArr = [];

            for (let i = 0; i < neo4jRawArr.length; i++) {
                if (neo4jRawArr[i].patientId === patientId) {
                    // Add the dataObj to the data array
                    patientTumorInfoArr.push(neo4jRawArr[i]);
                } 
            }
////////////////
//////////////// TODO
////////////////
            ...
            patient.tumorSummary = self.getTumorSummary(patientTumorInfoArr);
