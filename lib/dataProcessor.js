...
DataProcessor.prototype = {
    ...
    // Writing the debugging JSON into a file in the asynchronous way
    // Usage example: this.writeJsonFile("json/getCancerStages_neo4jRaw.json", neo4jRawJson);
    writeJsonFile: function(filepath, json) {
    ...
    getPatientEncounterAgeByDateString: function(encounterDateStr, birthday) {
    ...
    getAllPatients: function(neo4jRawJson) {
        this.writeJsonFile("json/getAllPatients_neo4jRaw.json", neo4jRawJson);
        var patientsJson = {};
        var dataArr = neo4jRawJson.results[0].data;
    ...
    getPatientInfo: function(neo4jRawJson) {
        ...
        var patientObj = neo4jRawJson.results[0].data[0].row[0];

        patientInfo.name = patientObj.name;
