...
class DataProcessor {
    ...
    static getTimelineData(neo4jRawJson) {
        ...
        _.forEach(sortedReportsArr, function(item) { 
            ...
            report.episode = self.capitalizeFirstLetter(item[4]); // Capitalized
    ...
    static getAllPatients(neo4jRawJson) {
        ...
        for (let i = 0; i < dataArr.length; i++) {
            ...
            // Add new property firstEncounterAge
            patient.firstEncounterAge = this.getPatientEncounterAgeByDateString(patient.firstEncounterDate, patient.birthday);
