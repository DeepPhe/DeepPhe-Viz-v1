...
class DataProcessor {
    ...
    static getCohortData(neo4jRawJson) {
        ...
        // // or
        // this.writeJsonFile("json/getCohortData_neo4jRaw.json", neo4jRawJson);
...
//console.log('stagesJson: ' + JSON.stringify(stagesJson, null, 4));
...
console.log('dataArr: ' + JSON.stringify(dataArr, null, 4));
    ...
    // neo4jRawJson is already a JSON object here
...
//console.log('dataArr: ' + JSON.stringify(dataArr, null, 4));
        ...
        for (let i = 0; i < dataArr.length; i++) {
            let patient = {};
            patient.id = dataArr[i].row[0].patientId; // id used later for cancerStages
            patient.name = dataArr[i].row[0].patientName;
