...
DataProcessor.prototype = {
    ...
    getTumorSummary: function(neo4jRawJson) {
        ...
        // Find the common categories across all tumors
        ...
        var sortedCommonFactRelationships = this.sortByProvidedOrder(commonFactRelationships, order);

        // Convert the 'hasXXX' relationship to category
        var commonCats = [];
        sortedCommonFactRelationships.forEach(function(item) {
        ...
        for (var k = 0; k < commonCats.length; k++) {
            var obj = {};
            obj.category = commonCats[k];
            obj.data = [];
