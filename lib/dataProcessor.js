...
DataProcessor.prototype = {
    ...
    getPatientsTumorInfo: function(neo4jRawJson) {
        ...
        uniquePatientsArr.forEach(function(patientName) {
            ...
            // so we can get the tumor summary directly
            ...
            //console.log(JSON.stringify(patientNeo4jRawJson, null, 4));
            ...
            patientsTumorInfo.patients.push(patient);
        });

        //console.log(JSON.stringify(patientsTumorInfo, null, 4));
