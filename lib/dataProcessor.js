...
//console.log(JSON.stringify(groupedTextProvenances, null, 4));
    ...
    prepareTimelineData: function(dataArr) {
        ...
        // Group the report objects by report time
        // This returns a named array, key is the time, value is an arry of reports with the same time
        var reportsGroupedByDate = _.groupBy(preparedReports.reportData, function(report) {
            return report.time;
        });

        preparedReports.reportsGroupedByDate = reportsGroupedByDate;
