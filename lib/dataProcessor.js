...
DataProcessor.prototype = {
    ...
    getCancerStages: function(neo4jRawJson) {
        ...
        sortedUniqueStages.forEach(function(stage) {
            ...
            for (var i = 0; i < dataArr.length; i++) {
                ...
                if ((shortStageName === stage) && (obj.patients.indexOf(patient) === -1)) {
    ...
    // The input `stage` is the shortStageName
    getPatients: function(neo4jRawJson, stage) {
        ...
        for (var i = 0; i < dataArr.length; i++) {
            ...
            patient.age = this.getPatientEncounterAge(dataArr[i].row[0].firstEncounterDate, dataArr[i].row[0].birthday);
