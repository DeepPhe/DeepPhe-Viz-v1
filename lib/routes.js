        ...
        handler: function (request, reply) {
            ...
            httpRequest({
                ...
                if ( ! error) {
                    ...
                    var data = {
                        stagesInfo: stagesObj.stagesInfo
                    };
                    ...
                    request.server.render('cancerStages', data, {layout: 'empty'}, (err, rendered, config) => {
                        ...
                        var result = {
                            renderedStages: rendered,
                            stagesData: stagesObj.stagesInfo
                        };
