            ...
            httpRequest({
                ...
                if ( ! error) {
                    ...
                    var data = {
                        ...
                        melanomaAttributes: ["Perineural Invasion", "Vertical Growth Phase", "Radial Growth Phase", "Regression", "Ulceration"]
                    };
            ...
            httpRequest({
                ...
                if ( ! error) {
                    ...
                    var data = {
                        ...
                        groupedTextMentions: factJson.groupedTextMentions // removed duplicates
                    };
                    ...
                    request.server.render('fact', data, {layout: 'empty'}, (err, rendered, config) => {
                        ...
                        var result = {
                            ...
                            textProvenancesArr: factJson.textProvenances, // May contain duplicates
                            reportId: reportId // use this reportId to get mentioned terms and report content
                        };
