...
const routes = [
    ...
    // Tumor chart URI route
    {
        ...
        // For API documentation with Swagger
        options: {
	        description: 'Patients Tumorinfo Endpoint', 
	        notes: 'Returns the grouped tumor information in JSON for a list of given patient IDs',
	        tags: ['api'],
	        validate: {
	            params: {
    ...
    // Diagnosis chart URI route
    {
        ...
        // For API documentation with Swagger
        options: {
	        description: 'Patients Diagnosis Endpoint', 
	        notes: 'Returns the diagnosis information in JSON for a list of given patient IDs',
	        tags: ['api'],
	        validate: {
	            params: {
	                patientIds : Joi.string()
    ...
    // Cancer and tumor summary URI route, called by client ajax
    {
        ...
        // For API documentation with Swagger
        options: {
	        description: 'Patient Cancer and Tumor Endpoint', 
	        notes: 'Returns all the cacners and tumors in JSON for a given patient ID',
	        tags: ['api'],
	        validate: {
	            params: {
	                patientId : Joi.string()
    ...
    // Reports timeline URI route, called by client ajax, no view template rendering
    {
        ...
        // For API documentation with Swagger
        options: {
	        description: 'Patient Timeline Data Endpoint', 
	        notes: 'Returns timeline data(reports, episodes) in JSON for a given patient ID',
	        tags: ['api'],
	        validate: {
	            params: {
	                patientId : Joi.string()
    ...
    // Fact information URI route, called by client ajax
    {
        ...
        // For API documentation with Swagger
        options: {
	        description: 'Fact Endpoint', 
	        notes: 'Returns fact data in JSON for a given fact ID',
	        tags: ['api'],
	        validate: {
	            params: {
	                factId : Joi.string()
