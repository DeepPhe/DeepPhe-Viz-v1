...
var restCallOptions = function(neo4jCypherQuery) {
...
var routes = [
    ...
    // cancerStages URI route
    {
        ...
        path:'/cancerStages', 
        handler: function (request, h) {
            var options = restCallOptions(neo4jCypherQueries.getPatients());
            var promise = httpRequestPromise(options)
                .then(function(body) {
    ...
    // Tumor chart URI route
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getPatientsTumorInfo(patientNames, cancer.id));
            var promise = httpRequestPromise(options)
                .then(function(body) {
                    // Convert the body into desired json data structure
    ...
    // Patient info
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getPatientInfo(patientName));
            var promise = httpRequestPromise(options)
                .then(function(body) {
                    // Convert the body into desired json data structure
    ...
    // Cancer summary URI route, called by client ajax
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getCancerSummary(patientName));
            var promise = httpRequestPromise(options)
                .then(function(body) {
                    // Convert the body into desired json data structure
    ...
    // Tumors summary URI route, called by client ajax
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getTumorSummary(patientName, cancerId));
            var promise = httpRequestPromise(options)
                .then(function(body) {
                    // Convert the body into desired json data structure
    ...
    // Reports timeline URI route, called by client ajax, no view template rendering
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getReports(patientName));
            var promise = httpRequestPromise(options)
                .then(function(body) {
    ...
    // Single report URI route, called by client ajax, no view template rendering
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getReport(reportId));
            var promise = httpRequestPromise(options)
                .then(function(body) {
    ...
    // Fact information URI route, called by client ajax
    {
        ...
        handler: function (request, h) {
            ...
            var options = restCallOptions(neo4jCypherQueries.getFact(factId));
            var promise = httpRequestPromise(options)
