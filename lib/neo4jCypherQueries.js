...
var neo4jCypherQueries = {
    ...
    getFacts: function() {
        ...
        // Because some facts don't have other associated facts via relationship, 
        // e.g., fact ID: "MedicalRecord_PrimaryTumor_105", "MedicalRecord_Negative_95", "MedicalRecord_Regional_Metastasis_105"
        var query = "MATCH (fact:Fact) " +
